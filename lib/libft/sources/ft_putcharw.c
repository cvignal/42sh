...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2018/11/18 07:36:59 by gchainet          #+#    #+#             */
/*   Updated: 2018/11/24 05:59:22 by gchainet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int					ft_putcharw(wchar_t c)
{
	...
	tmp_byte = (char)c;
	if (byte_count == 1)
		return (write(1, &tmp_byte, 1));
	else
	{
		c = write_first_byte(c, bits, byte_count);
		ret = 1;
		while (--byte_count)
		{
