...
/*   Updated: 2018/12/31 18:25:34 by gchainet         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static const t_ast_rule g_rules[] =\
{
	...
	{PS_ALL,
		{TT_WHILE, 0, 0, 0}, 1, &rule_create_while},
	{PS_IFNOCD,
	...
	{PS_ELSE,
		{TT_IFCD, TT_STATEMENT, TT_END, 0}, 3, &rule_add_to_else},
	{PS_ELSE,
		{TT_IFCD, TT_STATEMENT, TT_OVER, 0}, 3, &rule_add_to_else},
	{PS_WHILENOCD,
		{TT_WHILENOCD, TT_STATEMENT, TT_END, TT_DO}, 4, &rule_while_add_cd},
	{PS_WHILENOCD,
		{TT_WHILENOCD, TT_STATEMENT, TT_OVER, TT_DO}, 4, &rule_while_add_cd},
	{PS_WHILECD,
		{TT_WHILECD, TT_STATEMENT, 0, 0}, 2, &rule_while_add},
	{PS_WHILECD,
		{TT_WHILECD, TT_DONE, 0, 0}, 2, &rule_while_close},
	{PS_WHILECD,
		{TT_WHILECD, TT_END, 0, 0}, 2, &rule_shift_second},
	{PS_WHILECD,
		{TT_WHILECD, TT_OVER, 0, 0}, 2, &rule_shift_second},
	{PS_ALL,
